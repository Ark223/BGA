...
namespace BGA
{
    internal class Constraints : ICloneable
    {
        ...
        public Constraints(int minClubs,
            int maxClubs, int minDiamonds, int maxDiamonds,
            int minHearts, int maxHearts, int minSpades,
            int maxSpades, int minHcp, int maxHcp)
        {
        ...
        internal Constraints Copy() => (Constraints)this.Clone();
